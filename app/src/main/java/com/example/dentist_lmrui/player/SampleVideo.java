package com.example.dentist_lmrui.player;
...
public class SampleVideo extends StandardGSYVideoPlayer {
    ...
    private OnScreenShotListener screenShotListener;//回调接口
    public interface OnScreenShotListener{
        void onScreenShot(Bitmap shotmap);
    }
    ...
    void shotImage(final View v) {
        //获取截图
        GSYVideoShotListener shotListener = new GSYVideoShotListener() {
            @Override
            public void getBitmap(Bitmap bitmap) {
                if (bitmap != null) {
                    if(screenShotListener != null)
                        screenShotListener.onScreenShot(bitmap);
                    Toast.makeText(getContext(), "shot success ",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getContext(), "shot fail ",Toast.LENGTH_SHORT).show();
                }
            }
        };
        taskShotPic(shotListener);
    }
    /**
     * 需要在尺寸发生变化的时候重新处理
     */
    ...
    public int getLayoutId() {
        return R.layout.video_layout_samplevideo;
    }
